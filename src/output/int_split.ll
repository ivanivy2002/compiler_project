...
bb_while_5_14_cond:                               ; preds = %bb_while_5_14_whilestms, %bb2
...
bb_while_5_14_whilestms:                          ; preds = %bb_while_5_14_cond
  ...
  %r121 = getelementptr i32, ptr %r113, i32 %r120
...
bb3:                                              ; preds = %bb6
  ...
  %r132 = getelementptr [4 x i32], ptr %r130, i32 0, i32 0
  %r133 = call i32 @split(i32 %r131, ptr %r132)
  store i32 %r133, ptr %r129, align 4
  store i32 0, ptr %r128, align 4
  br label %bb_while_5_35_cond

bb_while_5_35_cond:                               ; preds = %bb_while_5_35_whilestms, %bb3
  %r135 = load i32, ptr %r128, align 4
  %r136 = icmp slt i32 %r135, 4
  br i1 %r136, label %bb_while_5_35_whilestms, label %bb_while_5_35_bre

bb_while_5_35_whilestms:                          ; preds = %bb_while_5_35_cond
  %r137 = load i32, ptr %r128, align 4
  %r138 = getelementptr [4 x i32], ptr %r130, i32 0, i32 %r137
  %r139 = load i32, ptr %r138, align 4
  store i32 %r139, ptr %r134, align 4
  %r140 = load i32, ptr %r134, align 4
...
bb_while_5_35_bre:                                ; preds = %bb_while_5_35_cond
  ret i32 0
}
