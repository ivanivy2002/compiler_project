...
bb_while_5_18_cond:                               ; preds = %bb_while_5_18_whilestms, %bb1
...
bb_while_5_18_whilestms:                          ; preds = %bb_while_5_18_cond
...
bb_while_9_30_cond:                               ; preds = %bb_if_13_31_end, %bb_while_5_26_whilestms
...
bb_while_9_30_whilestms:                          ; preds = %bb_while_9_30_cond
  ...
  br i1 %r131, label %bb37_31checksecond, label %bb_if_13_31_false

bb37_31checksecond:                               ; preds = %bb_while_9_30_whilestms
...
bb_if_13_31_true:                                 ; preds = %bb37_31checksecond
...
bb_if_13_31_false:                                ; preds = %bb37_31checksecond, %bb_while_9_30_whilestms
  br label %bb_if_13_31_end

bb_if_13_31_end:                                  ; preds = %bb_if_13_31_false, %bb_if_13_31_true
  %r140 = load i32, ptr %r123, align 4
  %r141 = add i32 %r140, 1
  store i32 %r141, ptr %r123, align 4
  br label %bb_while_9_30_cond

bb_while_9_30_bre:                                ; preds = %bb_while_9_30_cond
...
bb_while_9_39_cond:                               ; preds = %bb_if_13_40_end, %bb_while_9_30_bre
...
bb_while_9_39_whilestms:                          ; preds = %bb_while_9_39_cond
...
bb_if_13_40_true:                                 ; preds = %bb_while_9_39_whilestms
...
bb_if_17_41_true:                                 ; preds = %bb_if_13_40_true
...
bb_if_17_41_false:                                ; preds = %bb_if_13_40_true
  br label %bb_if_17_41_end

bb_if_17_41_end:                                  ; preds = %bb_if_17_41_false, %bb_if_17_41_true
  br label %bb_if_13_40_end

bb_if_13_40_false:                                ; preds = %bb_while_9_39_whilestms
  br label %bb_if_13_40_end

bb_if_13_40_end:                                  ; preds = %bb_if_13_40_false, %bb_if_17_41_end
  %r182 = load i32, ptr %r144, align 4
  %r183 = add i32 %r182, 1
  store i32 %r183, ptr %r144, align 4
  br label %bb_while_9_39_cond

bb_while_9_39_bre:                                ; preds = %bb_while_9_39_cond
...
bb_while_5_58_cond:                               ; preds = %bb_while_9_60_bre, %bb2
  %r189 = load i32, ptr %r186, align 4
  %r190 = load i32, ptr @n, align 4
  %r191 = icmp sle i32 %r189, %r190
  br i1 %r191, label %bb_while_5_58_whilestms, label %bb_while_5_58_bre

bb_while_5_58_whilestms:                          ; preds = %bb_while_5_58_cond
  store i32 1, ptr %r192, align 4
  br label %bb_while_9_60_cond

bb_while_9_60_cond:                               ; preds = %bb_if_13_61_end, %bb_while_5_58_whilestms
  %r193 = load i32, ptr %r192, align 4
  %r194 = load i32, ptr @n, align 4
  %r195 = icmp sle i32 %r193, %r194
  br i1 %r195, label %bb_while_9_60_whilestms, label %bb_while_9_60_bre

bb_while_9_60_whilestms:                          ; preds = %bb_while_9_60_cond
  %r196 = load i32, ptr %r186, align 4
  %r197 = load i32, ptr %r192, align 4
  %r198 = icmp eq i32 %r196, %r197
  br i1 %r198, label %bb_if_13_61_true, label %bb_if_13_61_false

bb_if_13_61_true:                                 ; preds = %bb_while_9_60_whilestms
  ...
  br label %bb_if_13_61_end

bb_if_13_61_false:                                ; preds = %bb_while_9_60_whilestms
...
bb_if_13_61_end:                                  ; preds = %bb_if_13_61_false, %bb_if_13_61_true
  %r210 = load i32, ptr %r192, align 4
  %r211 = add i32 %r210, 1
  store i32 %r211, ptr %r192, align 4
  br label %bb_while_9_60_cond

bb_while_9_60_bre:                                ; preds = %bb_while_9_60_cond
  %r212 = load i32, ptr %r186, align 4
  %r213 = add i32 %r212, 1
  store i32 %r213, ptr %r186, align 4
  br label %bb_while_5_58_cond

bb_while_5_58_bre:                                ; preds = %bb_while_5_58_cond
  store i32 1, ptr %r186, align 4
  br label %bb_while_5_75_cond

bb_while_5_75_cond:                               ; preds = %bb_while_5_75_whilestms, %bb_while_5_58_bre
  %r214 = load i32, ptr %r186, align 4
  %r215 = load i32, ptr @m, align 4
  %r216 = icmp sle i32 %r214, %r215
  br i1 %r216, label %bb_while_5_75_whilestms, label %bb_while_5_75_bre

bb_while_5_75_whilestms:                          ; preds = %bb_while_5_75_cond
...
bb_while_5_75_bre:                                ; preds = %bb_while_5_75_cond
  call void @Dijkstra()
  store i32 1, ptr %r186, align 4
  br label %bb_while_5_85_cond

bb_while_5_85_cond:                               ; preds = %bb_while_5_85_whilestms, %bb_while_5_75_bre
  %r229 = load i32, ptr %r186, align 4
  %r230 = load i32, ptr @n, align 4
  %r231 = icmp sle i32 %r229, %r230
  br i1 %r231, label %bb_while_5_85_whilestms, label %bb_while_5_85_bre

bb_while_5_85_whilestms:                          ; preds = %bb_while_5_85_cond
...
bb_while_5_85_bre:                                ; preds = %bb_while_5_85_cond
