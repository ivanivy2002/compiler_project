...
bb1:
  %r176 = add i32 0, 0
  %r177 = add i32 %r100, 0
  store i32 %r177, ptr @a, align 4
  %r178 = load i32, ptr @a, align 4
  ret i32 %r178
}
...
bb2:
  %r179 = add i32 0, 0
  %r180 = add i32 %r104, 0
  store i32 %r180, ptr @b, align 4
  %r181 = load i32, ptr @b, align 4
  ret i32 %r181
}
...
bb3:
  %r182 = add i32 0, 0
  %r183 = add i32 %r108, 0
  store i32 %r183, ptr @d, align 4
  %r184 = load i32, ptr @d, align 4
  ret i32 %r184
}
...
bb7:                                              ; preds = %bb6, %bb5
  %r195 = load i32, ptr @a, align 4
  call void @putint(i32 %r195)
  call void @putch(i32 32)
  %r196 = load i32, ptr @b, align 4
...
bb11:                                             ; preds = %bb10, %bb9
  %r201 = load i32, ptr @a, align 4
  call void @putint(i32 %r201)
  call void @putch(i32 32)
  %r202 = load i32, ptr @b, align 4
...
bb37:                                             ; preds = %bb41, %bb40
  call void @putch(i32 74)
  br label %bb39

bb38:                                             ; preds = %bb41, %bb35
  br label %bb39
...
bb42:                                             ; preds = %bb46, %bb39
  call void @putch(i32 75)
  br label %bb44

bb43:                                             ; preds = %bb46, %bb45
  br label %bb44
