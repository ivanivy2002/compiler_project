...
bb1:                                              ; preds = %bb2
  ...
  br i1 %r103, label %bb28_4checksecond, label %bb17_4false

bb28_4checksecond:                                ; preds = %bb1
  %r104 = load i32, ptr %r100, align 4
  %r105 = icmp sgt i32 %r104, 0
  br i1 %r105, label %bb17_4true, label %bb17_4false

bb17_4true:                                       ; preds = %bb28_4checksecond
  store i32 1, ptr %r102, align 4
  br label %bb17_4end

bb17_4false:                                      ; preds = %bb28_4checksecond, %bb1
  store i32 0, ptr %r102, align 4
  br label %bb17_4end

bb17_4end:                                        ; preds = %bb17_4false, %bb17_4true
  %r106 = load i32, ptr %r102, align 4
  store i32 %r106, ptr %r101, align 4
  br label %bb_while_5_5_cond

bb_while_5_5_cond:                                ; preds = %bb_while_5_5_whilestms, %bb17_4end
...
bb_while_5_5_whilestms:                           ; preds = %bb_while_5_5_cond
...
bb_while_5_5_bre:                                 ; preds = %bb_while_5_5_cond
