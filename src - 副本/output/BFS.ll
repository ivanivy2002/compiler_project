...
bb_while__46_5_cond:                              ; preds = %bb_while__46_5_whilestms, %bb3
...
bb_while__46_5_whilestms:                         ; preds = %bb_while__46_5_cond
...
bb_while__46_5_bre:                               ; preds = %bb_while__46_5_cond
  ret void
}
...
bb_while__72_5_cond:                              ; preds = %bb_while__78_9_bre, %bb6
...
bb_while__72_5_whilestms:                         ; preds = %bb_while__72_5_cond
...
bb_if__74_9_true:                                 ; preds = %bb_while__72_5_whilestms
  store i32 1, ptr %r187, align 4
  br label %bb_if__74_9_end

bb_if__74_9_false:                                ; preds = %bb_while__72_5_whilestms
  br label %bb_if__74_9_end

bb_if__74_9_end:                                  ; preds = %bb_if__74_9_false, %bb_if__74_9_true
...
bb_while__78_9_cond:                              ; preds = %bb_if__80_13_end, %bb_if__74_9_end
...
bb_while__78_9_whilestms:                         ; preds = %bb_while__78_9_cond
...
bb_if__80_13_true:                                ; preds = %bb_while__78_9_whilestms
...
bb_if__80_13_false:                               ; preds = %bb_while__78_9_whilestms
  br label %bb_if__80_13_end

bb_if__80_13_end:                                 ; preds = %bb_if__80_13_false, %bb_if__80_13_true
...
bb_while__78_9_bre:                               ; preds = %bb_while__78_9_cond
  br label %bb_while__72_5_cond

bb_while__72_5_bre:                               ; preds = %bb_while__72_5_cond
  store i32 0, ptr %r189, align 4
  br label %bb_while__87_5_cond

bb_while__87_5_cond:                              ; preds = %bb_while__87_5_whilestms, %bb_while__72_5_bre
...
bb_while__87_5_whilestms:                         ; preds = %bb_while__87_5_cond
...
bb_while__87_5_bre:                               ; preds = %bb_while__87_5_cond
...
bb_while__103_9_whilestms:                        ; preds = %bb_103_30checksecond
  %r240 = call i32 @getch()
  store i32 %r240, ptr %r230, align 4
  br label %bb_while__103_9_cond

bb_while__103_9_bre:                              ; preds = %bb_103_30checksecond, %bb_while__103_9_cond
  %r241 = load i32, ptr %r230, align 4
  %r242 = icmp eq i32 %r241, 81
  br i1 %r242, label %bb_if__106_9_true, label %bb_if__106_9_false

bb_if__106_9_true:                                ; preds = %bb_while__103_9_bre
...
bb_if__106_9_false:                               ; preds = %bb_while__103_9_bre
...
bb_if__106_9_end:                                 ; preds = %bb_if__106_9_false, %bb_if__106_9_true
  %r252 = load i32, ptr @m, align 4
  %r253 = sub i32 %r252, 1
  store i32 %r253, ptr @m, align 4
  br label %bb_while__101_5_cond

bb_while__101_5_bre:                              ; preds = %bb_while__101_5_cond
  ret i32 0
}
