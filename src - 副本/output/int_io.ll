...
bb_while__7_5_cond:                               ; preds = %bb_if__9_9_end, %bb_if__9_9_true, %bb1
  %r102 = icmp sgt i32 1, 0
  br i1 %r102, label %bb_while__7_5_whilestms, label %bb_while__7_5_bre

bb_while__7_5_whilestms:                          ; preds = %bb_while__7_5_cond
  %r103 = call i32 @getch()
...
bb_9_22checksecond:                               ; preds = %bb_while__7_5_whilestms
  %r108 = load i32, ptr %r101, align 4
  %r109 = icmp sgt i32 %r108, 9
  br i1 %r109, label %bb_if__9_9_true, label %bb_if__9_9_false

bb_if__9_9_true:                                  ; preds = %bb_9_22checksecond, %bb_while__7_5_whilestms
  br label %bb_while__7_5_cond

bb_if__9_9_false:                                 ; preds = %bb_9_22checksecond
  br label %bb_while__7_5_bre

bb_if__9_9_end:                                   ; No predecessors!
  br label %bb_while__7_5_cond

bb_while__7_5_bre:                                ; preds = %bb_if__9_9_false, %bb_while__7_5_cond
  %r110 = load i32, ptr %r101, align 4
  store i32 %r110, ptr %r100, align 4
  br label %bb_while__17_5_cond

bb_while__17_5_cond:                              ; preds = %bb_if__19_9_end, %bb_while__7_5_bre
  %r111 = icmp sgt i32 1, 0
  br i1 %r111, label %bb_while__17_5_whilestms, label %bb_while__17_5_bre

bb_while__17_5_whilestms:                         ; preds = %bb_while__17_5_cond
  %r112 = call i32 @getch()
...
bb_if__19_9_false:                                ; preds = %bb_19_23checksecond, %bb_while__17_5_whilestms
  br label %bb_while__17_5_bre

bb_if__19_9_end:                                  ; preds = %bb_if__19_9_true
  br label %bb_while__17_5_cond

bb_while__17_5_bre:                               ; preds = %bb_if__19_9_false, %bb_while__17_5_cond
...
bb_while__38_5_cond:                              ; preds = %bb_while__38_5_whilestms, %bb3
...
bb_while__43_5_cond:                              ; preds = %bb_while__43_5_whilestms, %bb_while__38_5_bre
...
bb_while__52_5_bre:                               ; preds = %bb_while__52_5_cond
  ret i32 0
}
