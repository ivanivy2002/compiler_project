...
bb1:                                              ; preds = %bb2
  ...
  br label %bb_while__8_5_cond

bb_while__8_5_cond:                               ; preds = %bb_while__8_5_whilestms, %bb1
  %r103 = load i32, ptr %r100, align 4
  %r104 = icmp slt i32 %r103, 10
  br i1 %r104, label %bb_while__8_5_whilestms, label %bb_while__8_5_bre

bb_while__8_5_whilestms:                          ; preds = %bb_while__8_5_cond
...
bb_while__8_5_bre:                                ; preds = %bb_while__8_5_cond
  ...
  br label %bb_while__23_5_cond

bb_while__23_5_cond:                              ; preds = %bb_if__26_9_end, %bb_while__8_5_bre
  ...
  br i1 %r127, label %bb_23_24checksecond, label %bb_while__23_5_bre

bb_23_24checksecond:                              ; preds = %bb_while__23_5_cond
  %r128 = load i32, ptr %r113, align 4
  %r129 = load i32, ptr %r112, align 4
  %r130 = icmp slt i32 %r128, %r129
  br i1 %r130, label %bb_while__23_5_whilestms, label %bb_while__23_5_bre

bb_while__23_5_whilestms:                         ; preds = %bb_23_24checksecond
  ...
  br i1 %r139, label %bb_if__26_9_true, label %bb_if__26_9_false

bb_if__26_9_true:                                 ; preds = %bb_while__23_5_whilestms
  %r140 = load i32, ptr %r114, align 4
  %r141 = sub i32 %r140, 1
  store i32 %r141, ptr %r112, align 4
  br label %bb_if__26_9_end

bb_if__26_9_false:                                ; preds = %bb_while__23_5_whilestms
  %r142 = load i32, ptr %r114, align 4
  %r143 = add i32 %r142, 1
  store i32 %r143, ptr %r113, align 4
  br label %bb_if__26_9_end

bb_if__26_9_end:                                  ; preds = %bb_if__26_9_false, %bb_if__26_9_true
  br label %bb_while__23_5_cond

bb_while__23_5_bre:                               ; preds = %bb_23_24checksecond, %bb_while__23_5_cond
  ...
  br i1 %r148, label %bb_if__36_5_true, label %bb_if__36_5_false

bb_if__36_5_true:                                 ; preds = %bb_while__23_5_bre
  %r149 = load i32, ptr %r111, align 4
  call void @putint(i32 %r149)
  br label %bb_if__36_5_end

bb_if__36_5_false:                                ; preds = %bb_while__23_5_bre
  store i32 0, ptr %r111, align 4
  %r150 = load i32, ptr %r111, align 4
  call void @putint(i32 %r150)
  br label %bb_if__36_5_end

bb_if__36_5_end:                                  ; preds = %bb_if__36_5_false, %bb_if__36_5_true
