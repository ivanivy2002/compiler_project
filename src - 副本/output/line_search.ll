...
bb_while__8_5_bre:                                ; preds = %bb_while__8_5_cond
  ...
  br label %bb_while__28_5_cond

bb_while__28_5_cond:                              ; preds = %bb_if__30_9_end, %bb_while__8_5_bre
  %r125 = load i32, ptr %r100, align 4
  %r126 = icmp slt i32 %r125, 10
  br i1 %r126, label %bb_28_19checksecond, label %bb_while__28_5_bre

bb_28_19checksecond:                              ; preds = %bb_while__28_5_cond
  %r127 = load i32, ptr %r123, align 4
  %r128 = icmp eq i32 %r127, 0
  br i1 %r128, label %bb_while__28_5_whilestms, label %bb_while__28_5_bre

bb_while__28_5_whilestms:                         ; preds = %bb_28_19checksecond
  ...
  br i1 %r133, label %bb_if__30_9_true, label %bb_if__30_9_false

bb_if__30_9_true:                                 ; preds = %bb_while__28_5_whilestms
  store i32 1, ptr %r123, align 4
  %r134 = load i32, ptr %r100, align 4
  store i32 %r134, ptr %r124, align 4
  br label %bb_if__30_9_end

bb_if__30_9_false:                                ; preds = %bb_while__28_5_whilestms
  br label %bb_if__30_9_end

bb_if__30_9_end:                                  ; preds = %bb_if__30_9_false, %bb_if__30_9_true
  %r135 = load i32, ptr %r100, align 4
  %r136 = add i32 %r135, 1
  store i32 %r136, ptr %r100, align 4
  br label %bb_while__28_5_cond

bb_while__28_5_bre:                               ; preds = %bb_28_19checksecond, %bb_while__28_5_cond
  %r137 = load i32, ptr %r123, align 4
  %r138 = icmp eq i32 %r137, 1
  br i1 %r138, label %bb_if__39_5_true, label %bb_if__39_5_false

bb_if__39_5_true:                                 ; preds = %bb_while__28_5_bre
  %r139 = load i32, ptr %r124, align 4
  call void @putint(i32 %r139)
  br label %bb_if__39_5_end

bb_if__39_5_false:                                ; preds = %bb_while__28_5_bre
