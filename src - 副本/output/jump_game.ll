...
bb_if__2_5_true:                                  ; preds = %bb1
  ret i32 1

bb_if__2_5_false:                                 ; preds = %bb1
  br label %bb_if__2_5_end

bb_if__2_5_end:                                   ; preds = %bb_if__2_5_false
...
bb_if__6_5_true:                                  ; preds = %bb_if__2_5_end
  ret i32 1

bb_if__6_5_false:                                 ; preds = %bb_if__2_5_end
  br label %bb_if__6_5_end

bb_if__6_5_end:                                   ; preds = %bb_if__6_5_false
  store i32 0, ptr %r111, align 4
  br label %bb_while__13_5_cond

bb_while__13_5_cond:                              ; preds = %bb_while__13_5_whilestms, %bb_if__6_5_end
...
bb_while__13_5_whilestms:                         ; preds = %bb_while__13_5_cond
...
bb_while__13_5_bre:                               ; preds = %bb_while__13_5_cond
...
bb_while__20_5_cond:                              ; preds = %bb_while__29_9_bre, %bb_while__13_5_bre
...
bb_if__22_9_true:                                 ; preds = %bb_while__20_5_whilestms
...
bb_if__22_9_false:                                ; preds = %bb_while__20_5_whilestms
...
bb_if__22_9_end:                                  ; preds = %bb_if__22_9_false, %bb_if__22_9_true
  br label %bb_while__29_9_cond

bb_while__29_9_cond:                              ; preds = %bb_if__31_13_end, %bb_if__22_9_end
...
bb_while__29_9_whilestms:                         ; preds = %bb_while__29_9_cond
...
bb_if__31_13_true:                                ; preds = %bb_while__29_9_whilestms
...
bb_if__31_13_false:                               ; preds = %bb_while__29_9_whilestms
  br label %bb_if__31_13_end
...
bb_while__29_9_bre:                               ; preds = %bb_while__29_9_cond
...
bb2:                                              ; preds = %bb4
  ...
  %r176 = getelementptr [10 x i32], ptr %r165, i32 0, i32 0
  %r177 = load i32, ptr %r164, align 4
  %r178 = call i32 @canJump(ptr %r176, i32 %r177)
  store i32 %r178, ptr %r164, align 4
  %r179 = load i32, ptr %r164, align 4
  ret i32 %r179
}
