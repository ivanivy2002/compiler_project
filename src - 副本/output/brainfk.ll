...
bb_while__17_3_cond:                              ; preds = %bb_while__17_3_whilestms, %bb1
...
bb_while__17_3_whilestms:                         ; preds = %bb_while__17_3_cond
...
bb_while__17_3_bre:                               ; preds = %bb_while__17_3_cond
...
bb_while__29_3_cond:                              ; preds = %bb_if__55_5_end, %bb2
  %r117 = load i32, ptr %r116, align 4
  %r118 = getelementptr [65536 x i32], ptr %r113, i32 0, i32 %r117
  %r119 = load i32, ptr %r118, align 4
  %r120 = icmp ne i32 %r119, 0
  br i1 %r120, label %bb_while__29_3_whilestms, label %bb_while__29_3_bre

bb_while__29_3_whilestms:                         ; preds = %bb_while__29_3_cond
  %r121 = load i32, ptr %r116, align 4
  %r122 = getelementptr [65536 x i32], ptr %r113, i32 0, i32 %r121
...
bb_if__39_5_false:                                ; preds = %bb_if__35_5_end
  br label %bb_if__39_5_end

bb_if__39_5_end:                                  ; preds = %bb_if__39_5_false, %bb_if__39_5_true
  %r140 = load i32, ptr %r114, align 4
  %r141 = icmp eq i32 %r140, 45
  br i1 %r141, label %bb_if__43_5_true, label %bb_if__43_5_false

bb_if__43_5_true:                                 ; preds = %bb_if__39_5_end
...
bb_if__43_5_false:                                ; preds = %bb_if__39_5_end
  br label %bb_if__43_5_end

bb_if__43_5_end:                                  ; preds = %bb_if__43_5_false, %bb_if__43_5_true
  %r148 = load i32, ptr %r114, align 4
  %r149 = icmp eq i32 %r148, 46
  br i1 %r149, label %bb_if__47_5_true, label %bb_if__47_5_false

bb_if__47_5_true:                                 ; preds = %bb_if__43_5_end
...
bb_if__47_5_false:                                ; preds = %bb_if__43_5_end
  br label %bb_if__47_5_end

bb_if__47_5_end:                                  ; preds = %bb_if__47_5_false, %bb_if__47_5_true
  %r153 = load i32, ptr %r114, align 4
  %r154 = icmp eq i32 %r153, 44
  br i1 %r154, label %bb_if__51_5_true, label %bb_if__51_5_false

bb_if__51_5_true:                                 ; preds = %bb_if__47_5_end
...
bb_if__51_5_false:                                ; preds = %bb_if__47_5_end
  br label %bb_if__51_5_end

bb_if__51_5_end:                                  ; preds = %bb_if__51_5_false, %bb_if__51_5_true
  %r158 = load i32, ptr %r114, align 4
  %r159 = icmp eq i32 %r158, 93
  br i1 %r159, label %bb_55_27checksecond, label %bb_if__55_5_false

bb_55_27checksecond:                              ; preds = %bb_if__51_5_end
...
bb_if__61_9_true:                                 ; preds = %bb_while__58_7_whilestms
  %r173 = load i32, ptr %r115, align 4
  %r174 = sub i32 %r173, 1
  store i32 %r174, ptr %r115, align 4
  br label %bb_if__61_9_end

bb_if__61_9_false:                                ; preds = %bb_while__58_7_whilestms
  br label %bb_if__61_9_end

bb_if__61_9_end:                                  ; preds = %bb_if__61_9_false, %bb_if__61_9_true
  %r175 = load i32, ptr %r114, align 4
  %r176 = icmp eq i32 %r175, 93
  br i1 %r176, label %bb_if__65_9_true, label %bb_if__65_9_false

bb_if__65_9_true:                                 ; preds = %bb_if__61_9_end
  %r177 = load i32, ptr %r115, align 4
  %r178 = add i32 %r177, 1
  store i32 %r178, ptr %r115, align 4
  br label %bb_if__65_9_end

bb_if__65_9_false:                                ; preds = %bb_if__61_9_end
  br label %bb_if__65_9_end

bb_if__65_9_end:                                  ; preds = %bb_if__65_9_false, %bb_if__65_9_true
  br label %bb_while__58_7_cond

bb_while__58_7_bre:                               ; preds = %bb_while__58_7_cond
  br label %bb_if__55_5_end

bb_if__55_5_false:                                ; preds = %bb_55_27checksecond, %bb_if__51_5_end
  br label %bb_if__55_5_end

bb_if__55_5_end:                                  ; preds = %bb_if__55_5_false, %bb_while__58_7_bre
  %r179 = load i32, ptr %r116, align 4
  %r180 = add i32 %r179, 1
  store i32 %r180, ptr %r116, align 4
  br label %bb_while__29_3_cond

bb_while__29_3_bre:                               ; preds = %bb_while__29_3_cond
  ret void
}
