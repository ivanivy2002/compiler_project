...
bb2:                                              ; preds = %bb4
  ...
  br i1 %r105, label %bb_if__11_5_true, label %bb_11_22checksecond

bb_11_22checksecond:                              ; preds = %bb2
  %r106 = call i32 @foo(i32 3)
  %r107 = icmp sgt i32 %r106, 0
  br i1 %r107, label %bb_if__11_5_true, label %bb_if__11_5_false

bb_if__11_5_true:                                 ; preds = %bb_11_22checksecond, %bb2
  store i32 2, ptr %r103, align 4
  br label %bb_if__11_5_end

bb_if__11_5_false:                                ; preds = %bb_11_22checksecond
  br label %bb_if__11_5_end

bb_if__11_5_end:                                  ; preds = %bb_if__11_5_false, %bb_if__11_5_true
